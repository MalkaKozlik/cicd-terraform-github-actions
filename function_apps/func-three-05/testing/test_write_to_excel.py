...
def test_write_and_upload(upload_blob_file):
    ...
    upload_blob_file.assert_called_once_with("connection_string", 'excel', 'alert_file.xlsx')
...
def test_upload_blob_file(BlobServiceClient):
    ...
    BlobServiceClient.from_connection_string().get_container_client.assert_called_once_with(container="container")
