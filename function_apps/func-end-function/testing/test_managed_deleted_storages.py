...
import pytest
from managed_deleted_storages import *
...
@patch('managed_deleted_storages.deleted_accounts_table',"aa")
@patch('managed_deleted_storages.upload_deleted_storages_table',Mock(return_value=''))
@patch('managed_deleted_storages.retrieve_data_from_table',Mock(return_value=[{'PartitionKey': '1', 'storage_name': 'myfirsttrail'},{'PartitionKey': '1', 'storage_name': 'mysecondtrail'}]))
@patch('managed_deleted_storages.return_the_first',  Mock(return_value={'PartitionKey': '1', 'storage_name': 'myfirsttrail'}))
def test_deleted_storages():
    deleted_storages("table_name",  1, ['myfirsttrail'])

@patch('managed_deleted_storages.deleted_accounts_table',"aa")
@patch('managed_deleted_storages.retrieve_data_from_table',Mock(return_value=[{'PartitionKey': '1', 'storage_name': 'myfirsttrail'},{'PartitionKey': '1', 'storage_name': 'mysecondtrail'}]))
@patch('managed_deleted_storages.upload_to_table')
@patch('managed_deleted_storages.return_the_first',  Mock(return_value={'PartitionKey': '1', 'storage_name': 'myfirsttrail'}))
...
@patch("managed_deleted_storages.convert_to_json", Mock(return_value=[]))
@patch("managed_deleted_storages.TableClient")
...
@patch("managed_deleted_storages.convert_to_json", Mock(return_value=[]))
@patch("managed_deleted_storages.TableClient",mock_Table_client())
...
@patch('managed_deleted_storages.convert_to_json',Mock(side_effect = ResourceNotFoundError("ResourceNotFoundError")))
@patch('managed_deleted_storages.TableClient')
...
@patch("managed_deleted_storages.connection_string", "123456-789456")
@patch("managed_deleted_storages.TableClient")
