...
resource "azurerm_function_app" "function_app" {
  ...
  app_settings ={
    ...
    KEYVAULT_URI = " "
    https_only                          = true
    DOCKER_REGISTRY_SERVER_URL          = var.DOCKER_REGISTRY_SERVER_URL_VARIABLE
    DOCKER_REGISTRY_SERVER_USERNAME     = var.DOCKER_REGISTRY_SERVER_USERNAME_VARIABLE
    DOCKER_REGISTRY_SERVER_PASSWORD     = var.DOCKER_REGISTRY_SERVER_PASSWORD_VARIABLE
