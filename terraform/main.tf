...
resource "azurerm_function_app" "function_app" {
  ...
  app_settings ={
    ...
    count.index==0 ? DESIRED_TIME_PERIOD_SINCE_LAST_RETRIEVAL_FOR_CHECK_LAST_FETCH = 30 : null
    count.index==0 ? TIME_INDEX_FOR_CHECK_LAST_FETCH = "days" : null
    count.index==0 ? WORKSPACE_ID = "fa9e707a-28c1-4528-b7b2-54d03360d4c9" : null
