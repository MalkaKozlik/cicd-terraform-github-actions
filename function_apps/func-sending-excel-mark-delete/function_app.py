...
from project import write_to_excel, managed_deleted_storages
...
def test_function(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        write_to_excel.write_to_excel(excel_connection_string, alerts_to_excel)
        ...
        managed_deleted_storages.deleted_storages(documentation_table, int(partition_key)-1 , all_storages)
